<template>
    <body>
        <div id="document">
            <div id="onePage">
                <div id="сitizenship">
                    <div id="сitizenship_1"></div>
                    <div id="сitizenship_2">
                        <div id="сitizenship_2_1">
                            <span>Замежны грамадзянін</span>
                        </div>
                        <div id="сitizenship_2_2">
                            <input class="textCenter" v-model="allDivsWithInput.сitizenship.сitizenship_1">
                        </div>
                        <div id="сitizenship_2_3">
                            <span>Асоба без грамадзянства</span>
                        </div>
                        <div id="сitizenship_2_4">
                            <input class="textCenter" v-model="allDivsWithInput.сitizenship.сitizenship_2">
                        </div>
                    </div>
                </div>
                <div id="firstParte">
...
export default {
    ...
    created() {
        bus.$on('send-residence-data', async (data) => {
            let response = await fetch(`${process.env.VUE_APP_BACKEND_ADDRESS}/api/send/Residence`, {
                method: 'POST',
                headers: {
...
#onePage {
    ...
    #second {
        ...
        #sp6 {
            ...
            #single input:checked + label:before, 
            #divorced input:checked + label:before, 
            #widow input:checked + label:before {
                content: "X";
            }
